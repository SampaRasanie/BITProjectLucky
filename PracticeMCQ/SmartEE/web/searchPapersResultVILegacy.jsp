                            ...
                            <tr class="center-text">
                               ...
                               <!-- <td><img id="imgTag"  height="50px" style="width:50px;  background-image: url(<% // out.write("uploads" + s[1] + ".jpg");%>);
                                ...
                                <td class="center-text">
                                    ...
                                    <a class="btn btn-danger btn-primary" style="background-color: red" href="TakeQuizVI.jsp?qsi=<% out.write(q.getIdquestionset()+"");%>">START</a>
                                    ...
                                    %>
                                     ...
                                     <!--   <input type="submit" id="btnactivatedeactivate" name="sta" class="btn btn-danger btn-primary" value="<%// out.write(sa); %>">-->
