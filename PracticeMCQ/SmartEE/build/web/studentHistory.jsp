...
<html lang="en">
    ...
    <body id="page-top" onload="javascript:ScaleSize();" onresize="history.go(0)">
        ...
        <div class="container-fluid">
            <h2>Practice Examination History</h2>
            <div class="row">
                <div class="col-12">
                    <table class="table table-hover" id="Question">
                        ...
                        <tbody>
                            <%                                String userid = "";
                                ...
                                User user = new Getting().getUserById(userid);
                                List<PracticeQuestionSet> prqueslist = new Getting().getPracticeQuestionSetByUser(user);
                                for (PracticeQuestionSet prques : prqueslist) {
                                    String subject = prques.getQuestionSet().getEnumSubject().getSubject();
                                    String title = prques.getQuestionSet().getName();
                                    String author = prques.getQuestionSet().getUser().getUsername();
                                    String paperstatus = prques.getQuestionSet().getEnumQuestionSetStatus().getStatus();
                                    String results = prques.getScore().toString();
                            %>
                            ...
                            <tr class="center-text">
                                ...
                                <td class="center-text"><% out.write("" + paperstatus);%></td>
                                <td class="center-text"><% out.write("" + results);%></td>
